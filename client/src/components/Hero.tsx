				...
				>
					<div className="flex flex-col justify-center items-start row-start-2 sm:row-start-1">
						<h1 className="text-3xl lg:text-4xl xl:text-5xl font-medium text-black-600 leading-normal">
							...
							<p>ทำให้การกรอกเเบบฟอร์มเป็นเรื่องง่าย</p>
						</h1>
						<p className="text-black-500 mt-4 mb-6">
							ครบจบในเว็บเดียว
							รวบรวมฟอร์มจากคณะต่างๆมาให้เพื่อคุณพร้อมระบบกรอกฟอร์มอัตโนมัติที่จะพาคุณเขียนแบบฟอร์มเสร็จภายในไม่กี่นาที
						</p>
						<button
						...
						<Link
							href={"/form"}
							className="bg-gray-400 flex justify-center hover:bg-gray-500 text-white font-bold rounded-xl p-4 w-50 w-6/12 mt-5"
						>
							<button>
