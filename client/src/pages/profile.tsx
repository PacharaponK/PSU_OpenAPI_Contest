							...
							{studentDetail ? (
								<div>
									<div className="text-md font-medium">
										...
										<h1 className="flex">
											หอพัก :{" "}
											{studentDetail.dorm ? studentDetail.dorm : "ไม่ระบุ"}
											<svg
												onClick={() => setModalOption("หอพัก")}
												className="hover:cursor-pointer w-6 h-6 ml-3 text-blue-600 dark:text-white"
												aria-hidden="true"
										...
										<h1
											onClick={() => setModalOption("ประเภททุนการศึกษา")}
											className="flex"
										>
											ประเภททุนการศึกษา :{" "}
											{studentDetail.scholarship
												? studentDetail.scholarship
												: "ไม่ระบุ"}
											<svg
												className="hover:cursor-pointer w-6 h-6 ml-3 text-blue-600 dark:text-white"
										...
										<h1
											onClick={() => setModalOption("ที่อยู่ปัจจุบัน")}
											className="flex"
										>
											ที่อยู่ปัจจุปัน :{" "}
